          ...
          >
            {user ? (
              <>
                <Link 
                  href="/dashboard" 
                  className="block px-4 py-2 text-base text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition-colors duration-200 font-medium rounded-lg"
                ...
                <div className="pt-3 mt-3 border-t border-gray-200 space-y-2">
                  ...
                  <button
                    ...
                    className="w-full mx-4 px-4 py-2.5 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg hover:shadow-lg transition-all duration-300 text-sm font-medium"
                  >
                    {t('navigation.signOut')}
                  </button>
                </div>
              ...
              <Link 
                href="/" 
                className="block mx-4 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full hover:shadow-lg transition-all duration-300 text-center font-medium"
                onClick={() => setIsMenuOpen(false)}
              >
                {t('navigation.signIn')}
              </Link>
